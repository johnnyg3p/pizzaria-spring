...
@EnableJpaRepositories(basePackages = "br.com.reload.pizzaria.modelos.repositorios")
public class ConfiguracaoDB {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws Exception {
        ...
        entityManagerFactoryBean.setPackagesToScan("br.com.reload.pizzaria.modelos.entidades");
